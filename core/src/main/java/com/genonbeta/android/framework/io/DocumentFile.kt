...
class DocumentFile private constructor(
    ...
    companion object {
        ...
        fun fromArchive(parent: DocumentFile, original: Uri, name: String, dir: Boolean, size: Long, lastModified: Long): DocumentFile {
            return DocumentFile(original, ArchiveData.from(parent, original, name, dir, size, lastModified))
        }
